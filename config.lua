...
Config.Locations = {
	-- PINK CAGE HOTEL
	{ name = 'Pink Cage 1', location = 'Pink Cage - Room 1', coords = vector3(307.1, -213.19, 54.22),q_length = 1.4, q_width = 0.6, q_minZ = 51.62, q_maxZ = 55.62, q_heading = 340, price = 50000, keyname = 'pinkcage1' },
	{ name = 'Pink Cage 2', location = 'Pink Cage - Room 2', coords = vector3(310.86, -203.37, 54.22),q_length = 1.4, q_width = 0.6, q_minZ = 51.62, q_maxZ = 55.62, q_heading = 340, price = 50000, keyname = 'pinkcage2' },
	{ name = 'Pink Cage 3', location = 'Pink Cage - Room 3', coords = vector3(315.89, -194.42, 54.23),q_length = 0.4, q_width = 1.4, q_minZ = 51.63, q_maxZ = 55.63, q_heading = 339, price = 50000, keyname = 'pinkcage3' },
	{ name = 'Pink Cage 4', location = 'Pink Cage - Room 4', coords = vector3(347.14, -199.78, 54.22),q_length = 1.6, q_width = 0.6, q_minZ = 51.82, q_maxZ = 55.82, q_heading = 337, price = 50000, keyname = 'pinkcage4' },
	{ name = 'Pink Cage 5', location = 'Pink Cage - Room 5', coords = vector3(343.42, -209.69, 54.09),q_length = 1.6, q_width = 0.6, q_minZ = 51.69, q_maxZ = 55.69, q_heading = 337, price = 50000, keyname = 'pinkcage5' },
	{ name = 'Pink Cage 6', location = 'Pink Cage - Room 6', coords = vector3(339.54, -219.54, 54.09),q_length = 1.6, q_width = 0.6, q_minZ = 51.69, q_maxZ = 55.69, q_heading = 337, price = 50000, keyname = 'pinkcage6' },
	{ name = 'Pink Cage 7', location = 'Pink Cage - Room 7', coords = vector3(314.83, -219.97, 58.02),q_length = 1.6, q_width = 0.6, q_minZ = 57.12, q_maxZ = 59.92, q_heading = 250, price = 50000, keyname = 'pinkcage7' },
	{ name = 'Pink Cage 8', location = 'Pink Cage - Room 8', coords = vector3(307.21, -213.32, 58.02),q_length = 1.6, q_width = 0.6, q_minZ = 57.12, q_maxZ = 59.92, q_heading = 160, price = 50000, keyname = 'pinkcage8' },
	{ name = 'Pink Cage 9', location = 'Pink Cage - Room 9', coords = vector3(311.0, -203.41, 58.02),q_length = 1.6, q_width = 0.6, q_minZ = 57.12, q_maxZ = 59.92, q_heading = 160, price = 50000, keyname = 'pinkcage9' },
	{ name = 'Pink Cage 10', location = 'Pink Cage - Room 10', coords = vector3(315.82, -194.56, 58.02),q_length = 1.6, q_width = 0.6, q_minZ = 57.12, q_maxZ = 59.92, q_heading = 250, price = 50000, keyname = 'pinkcage10' },
	{ name = 'Pink Cage 11', location = 'Pink Cage - Room 11', coords = vector3(334.89, -227.65, 58.02),q_length = 1.6, q_width = 0.6, q_minZ = 57.12, q_maxZ = 59.92, q_heading = 250, price = 50000, keyname = 'pinkcage11' },
	{ name = 'Pink Cage 12', location = 'Pink Cage - Room 12', coords = vector3(339.53, -219.56, 58.02),q_length = 1.6, q_width = 0.6, q_minZ = 57.12, q_maxZ = 59.92, q_heading = 160, price = 50000, keyname = 'pinkcage12' },
